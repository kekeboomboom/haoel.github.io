...
我自己实际搭建过，我购买了 AWS lightsail，但是网速还是没有机场的快。但是如果要买更快的线路，那么就要更多钱，可能要一个月七八十，甚至更贵。最后我还是选择使用机场。

我使用机场担心的问题，主要是纯净 IP 的问题，因为现在很多 AI 网站都会检测你的 IP，如果你的 IP 不干净，那么很可能就封号了。

我用过几个机场，但目前有所谓的家庭 IP 的机场是 [tagss 带家庭 IP](https://tagss.pro/#/auth/O1eB8sek)，我最近需要登录 ultra mobile 网站，用了他那个家庭 IP，确实就能成功登录了，看起来是起作用的。用其他机场，就很容易各种报错。
...
我最近用 Ultra Mobile 这个手机卡，目前接受验证码都是挺快的，很稳定。但是这个卡的风控很严，你需要用干净的 IP 访问他们的网站或者 app 才能登录，否则很容易就各种奇怪的报错，或者登录失败等等。还有一点很烦人的是，最近他总是给我发 voicemail，说我国际漫游没有积分了，但是我买的这个 PayGO 的计划中是本来就没有国际漫游的，然后我登录他的 APP 和官网之后，也看不到国际漫游的充值选项，真的是让人恼火。

Ultra Mobile 这个手机卡，我买的时候是让其他人给我激活的，但是以我这两天的登录经验来看，激活也是必须要干净的 IP 才能激活成功的。那么还是推荐这个机场 [tagss 带家庭 IP](https://tagss.pro/#/auth/O1eB8sek)，总之这是我第一个看到支持家庭 IP 的机场，价格的话确实比其他机场稍微贵一点，一个月将近六十块钱了。但是如果有使用 claude code 等用户，或者其他可能会封 IP 的网站，那就只能用这个机场了。以前 ChatGPT 对于 IP 的要求也很严格，现在 ChatGPT 倒是不怎么封号了。
...
如果你只是想注册个电报、推特、油管、ins、google 等等，你只是作为消费者，去这些网站娱乐的，你不在意手机号是不是永久属于你的，只要让你过了注册这么门槛就行。那么推荐你用接码平台，这些平台会提供一个一次性的手机号，然后把验证码发给你。但是这个手机号只能用一次。

多了不说，上链接：[接码平台](https://sms-activate.io/cn)，我用着平台接受了几次验证码，他是根据地区来区分价格的，但是一般就是几块钱一次验证码。然后的话他支持如果这个手机号接码失败了，可以做刷新，如果一直失败，他会退给钱的，不用担心他吞钱。我反正觉得他的验证码接受的挺慢的，当然是对比现在我自己的 Ultra Mobile 手机卡来说啦～～



#### 5.1.3 错误路径

因为很多平台并不在意你一定是美国手机号，因此我以为用香港的手机号也可以注册各种 APP，但是最近我买了一个中国电信香港的流量卡，这个流量卡虽然可以登录各种 Google 服务，刷 YouTube，但是他不能接受验证码！！！

所以其他同志，在看到网上卖香港卡的，一定要擦亮眼睛，很多卡的手机号是被用烂的，被拉黑了，根本就接受不了验证码。
...
其实关于付钱，管制还是比较放松的。我直接用招商银行的visa 卡，就能对 ChatGPT 或者其他需要海外付款的账户付款。付款方面相对于收款，还是太太太轻松了。如果你看收款的各种条件限制，那就真的头大。



当然了，海外还有其他各种软件，我不清楚一个招商银行的 visa 卡是否能够走遍天下。如果你想更方便点，这个网站 [wildcard](https://bewildcard.com/i/KE31) 专门做国内订阅海外软件的服务，你用中国大陆的手机号注册，然后他会给你一张美国的银行卡号，这个银行卡的各种信息，比如卡号、地址等等都是美国的。他还提供各种 AI 软件订阅服务，还代理各种 AI 模型的 API，有兴趣的可以看看。



#### 关于收款

这个很麻烦，目前我也没有去尝试过，因为我光看网上的各种教程就感觉不好做，而且他的试错成本是几百、几千。

但是我也搜索了一些方案，比如对于个人开发者，不想注册公司的，可以用https://www.paddle.com/，但我没试过。

但是我发现了一些教程网站：https://itangtalk.com/

如果有个人开发者，搞定了这个收款，请一定要分享出来啊，我们要出海！！当然如果不想公开分享，那么私信我，让我恰独食也是可以的～～
